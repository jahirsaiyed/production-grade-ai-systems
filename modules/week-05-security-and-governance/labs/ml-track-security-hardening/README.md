...
The `artifacts/` directory committed to this repo is a publication-only demo, encrypted with a key
that is intentionally not published anywhere in this repo — it exists so the repo has something to
ship, not so you can run it. You
